...
namespace Febucci.UI.Core.Editors
{
    ...
    class TextAnimatorDrawer : Editor
    {
        ...
        {
            public SerializedProperty tagsContainer;
        ...
        public override void OnInspectorGUI()
        {
...

            {
                ...
                {
                    StartToggleGroup(ref panel_editDefaultAppearances, $"Default Appearances [{appDefaultPreset.defaultAppearanceCount} enabled]", boldFoldout);
                    if (panel_editDefaultAppearances)
                    {
                        EditFallbackEffects(ref appDefaultPreset.tagsContainer, true);
                        EditorGUILayout.Space();
                    }
